...

{
  ...
  \relative c' {
    ...
    <a-0 e'-1 d'-4> [cis'-2 d32-3 cis-2 b-0 cis-2]\bar "" \break
    <d,-0 a'-3 d-4>4\mark \default
    ...
    <b,-2 e-3 d'-4>8 [<a-0 e'-1 d'-4>16 cis'-2]
    d32-3 [cis-2 b-0 cis-2]
    <d,-0 a'-3 d-4>4.\fermata
    \bar "|."
    \hideNotes c,
